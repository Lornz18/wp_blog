          ...
          <div class="banner__grid">
            <div class="banner__main">
              ...
              <article class="banner__story">
                <!-- <img src="<?php echo get_template_directory_uri();?>./img/img-1.webp" alt="" /> -->
            ...
            <div class="banner__sidebar">
                ...
                <div class="card__sm">
                    <!-- <img src="<?php echo get_template_directory_uri();?>./img/img-3.webp" alt="" /> -->
                    <?php echo get_the_post_thumbnail();?>
                    <div class="card__sm__content">
                    <small><?php echo get_the_date('M d, Y');?></small>
                    <h3><?php echo wp_trim_words(the_title(),5);?></h3>
                    <a href="#">Read More...</a>
                    </div>
                </div>
                <?php 
    ...
    <section class="latest">
      <div class="container">
        ...
        <div class="latest__wrapper">
          ...
          <div class="card__md">
            <!-- <img src="<?php echo get_template_directory_uri();?>./img/img-6.webp" alt="" /> -->
            <?php echo get_the_post_thumbnail();?>
          ...
          <!-- <div class="card__md">
            <img src="<?php echo get_template_directory_uri();?>./img/img-7.webp" alt="" />
            <div class="card__md__content">
              <ul>
          ...
          <div class="card__md">
            <img src="<?php echo get_template_directory_uri();?>./img/img-8.webp" alt="" />
            <div class="card__md__content">
              <ul>
                <li><small>May 21, 2010</small></li>
                <li><small>Fashion</small></li>
    ...
    <section class="feature">
      ...
      <div class="container">
        <div class="feature__img">
          <img src="<?php echo get_template_directory_uri();?>./img/img-9.webp" alt="" />
        </div>
      </div>
        ...
        <div class="feature__wrapper">
          <div class="feature__main">
            <article class="card__lg">
              <img src="<?php echo get_template_directory_uri();?>./img/img-10.webp" alt="" />
            ...
            <article class="card__lg">
              <img src="<?php echo get_template_directory_uri();?>./img/img-11.webp" alt="" />
              <div class="card__lg__content">
                <small>Oct 2, 2022</small>
                <h3>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
            ...
            <article class="card__lg">
              <img src="<?php echo get_template_directory_uri();?>./img/img-12.webp" alt="" />
              <div class="card__lg__content">
                <small>Oct 2, 2022</small>
                <h3>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
